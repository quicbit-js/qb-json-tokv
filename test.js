...
test('next_src', function (t) {
  t.table_assert([
    ...
    [ '{"a":3',     ',"bc":44}',          [ 'B@0,{@0,k3@1:E1@5!D', 'd', 'B@0,k3@0:d1@4,E@6', 'B@0,k4@0:d2@5,}@7,E@8' ] ],
...
test('next_src - incomplete', function (t) {
  t.table_assert([
    ...
    [ '{"a',      '": 3',    [ 'B@0,{@0,k2@1:E@3!T', 'E', 'B@0,k3@0:E1@5!D', 'B@0,E@0' ] ],
    ...
    [ '{"a":',    ' 3',      [ 'B@0,{@0,k3@1:E@5', 'E', 'B@0,k3@0:E1@5!D', 'B@2,E@2' ] ],
    [ '{"a":3',   '',        [ 'B@0,{@0,k3@1:E1@5!D', 'E', 'B@0,k3@0:E1@4!D', 'B@0,E@0' ] ],
    [ '{"a":3',   ' ',       [ 'B@0,{@0,k3@1:E1@5!D', 'd', 'B@0,k3@0:d1@4,E@6', 'B@0,E@0' ] ],
...
test('parse error state', function (t) {
  t.tableAssert(
    [
      ...
      [ '[3.05E-2,4.',      [ 'B@0,[@0,d7@1,d2@9', '11/1/[W' ] ],
      [ '{"a',              [ 'B@0,{@0', '3/0/{K2' ] ],
