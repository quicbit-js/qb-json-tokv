...
test('tokenize', function (t) {
  t.tableAssert(
    [
      ...
      [ '1',                                        0,     null,  [ 'B@0,d1@0,E@1', 'DONE', '0/1:1/.' ] ],
      [ '1,2,3',                                    0,     null,  [ 'd1@2,d1@4,E@5', 'DONE', '2/5:5/.' ] ],
      [ '[1, 2], 3',                                0,     null,  [ ']@5,d1@8,E@9', 'DONE', '3/9:9/.' ]         ],
      [ '"x"',                                      0,     null,  [ 'B@0,S3@0,E@3', 'DONE', '1/3:3/.' ]         ],
      [ '-3.05',                                    0,     null,  [ 'B@0,d5@0,E@5', 'DONE', '0/5:5/.' ]         ],
      [ '-3.05',                                    1,     null,  [ 'B@1,d4@1,E@5', 'DONE', '0/4:4/.' ]         ],
      [ '  true',                                   0,     null,  [ 'B@0,t@2,E@6', 'DONE', '1/6:6/.' ]          ],
      [ ' false  ',                                 0,     null,  [ 'B@0,f@1,E@8', 'DONE', '1/8:8/.' ]          ],
      [ ' false   ',                                1,     null,  [ 'B@1,f@1,E@9', 'DONE', '1/8:8/.' ]          ],
      [ '[1, 2, 3]',                                0,     null,  [ 'd1@7,]@8,E@9', 'DONE', '4/9:9/.' ]         ],
      [ '[3.05E-2]',                                0,     null,  [ 'd7@1,]@8,E@9', 'DONE', '2/9:9/.' ]         ],
      [ '[3.05E-2]',                                4,     5,     [ 'B@4,d1@4,E@5', 'DONE', '0/1:1/.' ]         ],
      [ '{"a":1}',                                  0,     null,  [ 'K3@1:d1@5,}@6,E@7', 'DONE', '2/7:7/.' ]    ],
      [ '{"a"  :1}',                                0,     null,  [ 'K3@1:d1@7,}@8,E@9', 'DONE', '2/9:9/.' ]    ],
      [ '{ "a" : 1 }',                              0,     null,  [ 'K3@2:d1@8,}@10,E@11', 'DONE', '2/11:11/.' ] ],
      [ '"\\""',                                    0,     null,  [ 'B@0,S4@0,E@4', 'DONE', '1/4:4/.' ]         ],
      [ '"\\\\"',                                   0,     null,  [ 'B@0,S4@0,E@4', 'DONE', '1/4:4/.' ]         ],
      [ '\t\t"x\\a\r"  ',                           0,     null,  [ 'B@0,S6@2,E@10', 'DONE', '1/10:10/.' ]       ],
      [ '"\\"x\\"a\r\\""',                          0,     null,  [ 'B@0,S11@0,E@11', 'DONE', '1/11:11/.' ]      ],
      [ ' [0,1,2]',                                 0,     null,  [ 'd1@6,]@7,E@8', 'DONE', '4/8:8/.' ]         ],
...
test('tokenize - errors', function (t) {
  t.tableAssert(
    [
      ...
      // unexpected bytes
      [ '0*',               [ 'B@0,d1@0,!1@1: unexpected byte "*", after value at 1', 'UNEXP_BYTE', '1/2:2/.' ]                      ],
      [ '{"a":3^6}',        [ '{@0,K3@1:d1@5,!1@6: unexpected byte "^", in object after value at 6', 'UNEXP_BYTE', '1/7:9/{.' ]       ],
      [ ' 1f',              [ 'B@0,d1@1,!1@2: unexpected byte "f", after value at 2', 'UNEXP_BYTE', '1/3:3/.' ]                      ],
      ...
      [ '0{',               [ 'B@0,d1@0,!1@1: unexpected token "{", after value at 1', 'UNEXP_VAL', '1/2:2/.' ]                      ],
...
test('callback stop', function (t) {
  t.table_assert(
    [
      ...
      [ '{ "a": 7, "b": 4 }', 2,       false, [ 'B@0,{@0,K3@2:d1@7',          'TRUNC_SRC',  '1/8:18/{.' ] ],
...
test('incremental clean',         function (t) {
  t.table_assert(
    [
      [ 'input',                  'exp'                                        ],
      [ '',                       [ 'B@0,E@0',                'DONE', '0/0:0/-' ] ],
      [ '3.23e12',                [ 'B@0,d7@0,E@7',           'DONE', '0/7:7/.' ] ],
      [ '"abc"',                  [ 'B@0,S5@0,E@5',           'DONE', '1/5:5/.' ] ],
      [ '[ 83 ]',                 [ 'd2@2,]@5,E@6',           'DONE', '2/6:6/.' ] ],
      [ '[ 83, "a" ]',            [ 'S3@6,]@10,E@11',         'DONE', '3/11:11/.' ] ],
      [ '{ "a": 3 }',             [ 'K3@2:d1@7,}@9,E@10',     'DONE', '2/10:10/.' ] ],
      [ '{ "a": 3, "b": 8 }',     [ 'K3@10:d1@15,}@17,E@18',  'DONE', '3/18:18/.' ] ],
      [ '{ "a": 3, "b": [1,2] }', [ ']@19,}@21,E@22',         'DONE', '5/22:22/.' ] ],
      [ 'null',                   [ 'B@0,n@0,E@4',            'DONE', '1/4:4/.' ] ],
      [ ' 7E4 ',                  [ 'B@0,d3@1,E@5',           'DONE', '1/5:5/.' ] ],
...
test('incremental', function (t) {
  t.table_assert(
    [
      ...
      [ '[ 83 '              ,  [ '[@0,d2@2,E@5',              'TRUNC_SRC', '1/5:5/[.' ] ],
      [ '[ 83 ,'             ,  [ '[@0,d2@2,E@6',              'TRUNC_SRC', '1/6:6/[+' ] ],
      [ '[ 83 , "a"'         ,  [ 'd2@2,S3@7,E@10',            'TRUNC_SRC', '2/10:10/[.' ] ],
      [ '[ 83 , "a",'        ,  [ 'd2@2,S3@7,E@11',            'TRUNC_SRC', '2/11:11/[+' ] ],
      [ '[ 83 , "a", 2'      ,  [ 'd2@2,S3@7,E1@12',           'TRUNC_VAL', '2/13:13/[1' ] ],
      [ '{'                  ,  [ 'B@0,{@0,E@1',               'TRUNC_SRC', '0/1:1/{-' ] ],
      [ '{ "a"'              ,  [ 'B@0,{@0,K3@2:E@5',          'TRUNC_SRC', '0/5:5/{3.' ] ],
      [ '{ "a":'             ,  [ 'B@0,{@0,K3@2:E@6',          'TRUNC_SRC', '0/6:6/{3:' ] ],
      [ '{ "a": 9'           ,  [ 'B@0,{@0,K3@2:E1@7',         'TRUNC_VAL', '0/8:8/{3.1:1' ] ],
      [ '{ "a": 93, '        ,  [ '{@0,K3@2:d2@7,E@11',        'TRUNC_SRC', '1/11:11/{+' ] ],
      [ '{ "a": 93, "b'      ,  [ '{@0,K3@2:d2@7,E2@11',       'TRUNC_KEY', '1/13:13/{2' ] ],
      [ '{ "a": 93, "b"'     ,  [ '{@0,K3@2:d2@7,K3@11:E@14',  'TRUNC_SRC', '1/14:14/{3.' ] ],
      [ '{ "a": 93, "b":'    ,  [ '{@0,K3@2:d2@7,K3@11:E@15',  'TRUNC_SRC', '1/15:15/{3:' ] ],
      [ '{ "a": 93, "b": ['  ,  [ 'K3@2:d2@7,K3@11:[@16,E@17', 'TRUNC_SRC', '1/17:17/{[-' ] ],
...
test('initial state', function (t) {
  ...
  t.table_assert([
    ...
    // [ '{"a": 3.3}',     4,      null,   null,  OBJ|a_K, TRUNC_vAL, [o],     [ 'B@4', 'd3@6', '}@9', 'E@10' ] ],
