...
test('tokenize', function (t) {
  t.tableAssert(
    [
      [ 'src',                                      'off', 'lim', 'exp'                                             ],
      [ '1',                                        0,     null,  [ 'B@0,N1@0,E@1', 'DONE', '0/1:1/-/bfv/-' ] ],
      [ '1,2,3',                                    0,     null,  [ 'N1@2,N1@4,E@5', 'DONE', '2/5:5/-/b_v/-' ] ],
      [ '[1, 2], 3',                                0,     null,  [ ']@5,N1@8,E@9', 'DONE', '3/9:9/-/b_v/-' ]         ],
      [ '"x"',                                      0,     null,  [ 'B@0,S3@0,E@3', 'DONE', '1/3:3/-/a_v/-' ]         ],
      [ '-3.05',                                    0,     null,  [ 'B@0,N5@0,E@5', 'DONE', '0/5:5/-/bfv/-' ]         ],
      [ '-3.05',                                    1,     null,  [ 'B@1,N4@1,E@5', 'DONE', '0/4:4/-/bfv/-' ]         ],
      [ '  true',                                   0,     null,  [ 'B@0,t@2,E@6', 'DONE', '1/6:6/-/a_v/-' ]          ],
      [ ' false  ',                                 0,     null,  [ 'B@0,f@1,E@8', 'DONE', '1/8:8/-/a_v/-' ]          ],
      [ ' false   ',                                1,     null,  [ 'B@1,f@1,E@9', 'DONE', '1/8:8/-/a_v/-' ]          ],
      [ '[1, 2, 3]',                                0,     null,  [ 'N1@7,]@8,E@9', 'DONE', '4/9:9/-/a_v/-' ]         ],
      [ '[3.05E-2]',                                0,     null,  [ 'N7@1,]@8,E@9', 'DONE', '2/9:9/-/a_v/-' ]         ],
      [ '[3.05E-2]',                                4,     5,     [ 'B@4,N1@4,E@5', 'DONE', '0/1:1/-/bfv/-' ]         ],
      [ '{"a":1}',                                  0,     null,  [ 'K3@1:N1@5,}@6,E@7', 'DONE', '2/7:7/-/a_v/-' ]    ],
      [ '{"a"  :1}',                                0,     null,  [ 'K3@1:N1@7,}@8,E@9', 'DONE', '2/9:9/-/a_v/-' ]    ],
      [ '{ "a" : 1 }',                              0,     null,  [ 'K3@2:N1@8,}@10,E@11', 'DONE', '2/11:11/-/a_v/-' ] ],
      [ '"\\""',                                    0,     null,  [ 'B@0,S4@0,E@4', 'DONE', '1/4:4/-/a_v/-' ]         ],
      [ '"\\\\"',                                   0,     null,  [ 'B@0,S4@0,E@4', 'DONE', '1/4:4/-/a_v/-' ]         ],
      [ '\t\t"x\\a\r"  ',                           0,     null,  [ 'B@0,S6@2,E@10', 'DONE', '1/10:10/-/a_v/-' ]       ],
      [ '"\\"x\\"a\r\\""',                          0,     null,  [ 'B@0,S11@0,E@11', 'DONE', '1/11:11/-/a_v/-' ]      ],
      [ ' [0,1,2]',                                 0,     null,  [ 'N1@6,]@7,E@8', 'DONE', '4/8:8/-/a_v/-' ]         ],
      [ '["a", "bb"] ',                             0,     null,  [ 'S4@6,]@10,E@12', 'DONE', '3/12:12/-/a_v/-' ]      ],
      [ '"x", 4\n, null, 3.2e5 , true, false',      null,  null,  [ 't@23,f@29,E@34', 'DONE', '6/34:34/-/a_v/-' ]      ],
      [ '["a",1.3,\n\t{ "b" : ["v", "w"]\n}\t\n ]', null,  null,  [ '}@30,]@34,E@35', 'DONE', '7/35:35/-/a_v/-' ]      ],
    ],
...
test('tokenize - errors', function (t) {
  t.tableAssert(
    [
      ...
      // unexpected bytes
      [ '0*',               [ 'B@0,N1@0,!1@1: unexpected byte "*", after value at 1', 'UNEXP_BYTE', '1/2:2/-/a_v/-' ]                      ],
      [ '{"a":3^6}',        [ '{@0,K3@1:N1@5,!1@6: unexpected byte "^", in object after value at 6', 'UNEXP_BYTE', '1/7:9/{/a_v/-' ]       ],
      [ ' 1f',              [ 'B@0,N1@1,!1@2: unexpected byte "f", after value at 2', 'UNEXP_BYTE', '1/3:3/-/a_v/-' ]                      ],
      [ '1,2n',             [ 'N1@0,N1@2,!1@3: unexpected byte "n", after value at 3', 'UNEXP_BYTE', '2/4:4/-/a_v/-' ]                     ],

      // unexpected values
      [ '"a""b"',           [ 'B@0,S3@0,!3@3: unexpected string "b", after value at 3..5', 'UNEXP_VAL', '1/6:6/-/a_v/-' ]                  ],
      ...
      [ '0{',               [ 'B@0,N1@0,!1@1: unexpected token "{", after value at 1', 'UNEXP_VAL', '1/2:2/-/a_v/-' ]                      ],
      ...
      [ '[ 1, 2 ] "c',      [ 'N1@5,]@7,!2@9: unexpected string "c, after value at 9..10', 'UNEXP_VAL', '3/11:11/-/a_v/-' ]                 ],
      [ '[ 1, 2 ] "c"',     [ 'N1@5,]@7,!3@9: unexpected string "c", after value at 9..11', 'UNEXP_VAL', '3/12:12/-/a_v/-' ]                ],

      // truncated values / keys (not an error in incremental mode)
      [ 'fal',              [ 'B@0,!3@0: truncated token, first value at 0..2', 'TRUNC_VAL', '0/3:3/-/bfv/b3' ]                            ],
      [ '"ab',              [ 'B@0,!3@0: truncated string, first value at 0..2', 'TRUNC_VAL', '0/3:3/-/bfv/s3' ]                           ],
      [ '"ab:',             [ 'B@0,!4@0: truncated string, first value at 0..3', 'TRUNC_VAL', '0/4:4/-/bfv/s4' ]                           ],
      [ '"\\\\\\"',         [ 'B@0,!5@0: truncated string, first value at 0..4', 'TRUNC_VAL', '0/5:5/-/bfv/s5' ]                           ],
      [ '[3.05E-2',         [ 'B@0,[@0,!7@1: truncated number, in array first value at 1..7', 'TRUNC_VAL', '0/8:8/[/bfv/n7' ]              ],
      [ '[3.05E-2,4.',      [ '[@0,N7@1,!2@9: truncated number, in array value at 9..10', 'TRUNC_VAL', '1/11:11/[/b_v/n2' ]                 ],
      [ '{"a": t,',         [ 'B@0,{@0,K3@1:!1@6: truncated token, in object value at 6', 'TRUNC_VAL', '0/7:8/{/b_v/b1:2:3' ]                  ],
      [ '{"a',              [ 'B@0,{@0,!2@1: truncated string, in object first key at 1..2', 'TRUNC_VAL', '0/3:3/{/bfk/s2' ]               ],
...
test('callback stop', function (t) {
  t.table_assert(
    [
      [ 'src',                'at_cb', 'ret', 'exp' ],
      [ '{ "a": 7, "b": 4 }', 0,       false, [ 'B@0',                        'CLEAN_STOP', '0/0:18/-/bfv/-' ] ],
      [ '{ "a": 7, "b": 4 }', 1,       false, [ 'B@0,{@0',                    'TRUNC_SRC',  '0/1:18/{/bfk/-' ] ],
      [ '{ "a": 7, "b": 4 }', 2,       false, [ 'B@0,{@0,K3@2:N1@7',          'TRUNC_SRC',  '1/8:18/{/a_v/-' ] ],
      [ '{ "a": 7, "b": 4 }', 3,       false, [ '{@0,K3@2:N1@7,K3@10:N1@15',  'TRUNC_SRC',  '2/16:18/{/a_v/-' ] ],
      // note that if callback returns false when parsing is done the info still has a DONE code (but no END callback).
      [ '{ "a": 7, "b": 4 }', 4,       false, [ 'K3@2:N1@7,K3@10:N1@15,}@17', 'DONE',       '3/18:18/-/a_v/-' ] ],
    ],
...
test('incremental clean',         function (t) {
  t.table_assert(
    [
      [ 'input',                  'exp'                                        ],
      [ '',                       [ 'B@0,E@0',                'DONE', '0/0:0/-/bfv/-' ] ],
      [ '"abc"',                  [ 'B@0,S5@0,E@5',           'DONE', '1/5:5/-/a_v/-' ] ],
      [ '[ 83 ]',                 [ 'N2@2,]@5,E@6',           'DONE', '2/6:6/-/a_v/-' ] ],
      [ '[ 83, "a" ]',            [ 'S3@6,]@10,E@11',         'DONE', '3/11:11/-/a_v/-' ] ],
      [ '3.23e12',                [ 'B@0,N7@0,E@7',           'DONE', '0/7:7/-/bfv/-' ] ],
      [ '{ "a": 3 }',             [ 'K3@2:N1@7,}@9,E@10',     'DONE', '2/10:10/-/a_v/-' ] ],
      [ '{ "a": 3, "b": 8 }',     [ 'K3@10:N1@15,}@17,E@18',  'DONE', '3/18:18/-/a_v/-' ] ],
      [ '{ "a": 3, "b": [1,2] }', [ ']@19,}@21,E@22',         'DONE', '5/22:22/-/a_v/-' ] ],
      [ 'null',                   [ 'B@0,n@0,E@4',            'DONE', '1/4:4/-/a_v/-' ] ],
      [ ' 7E4 ',                  [ 'B@0,N3@1,E@5',           'DONE', '1/5:5/-/a_v/-' ] ],
      [ '{ "a": 93, "b": [] }',   [ ']@17,}@19,E@20',         'DONE', '3/20:20/-/a_v/-' ] ],
    ],
    function (src) {
      var hector = t.hector()
      var endinfo = null
...
test('incremental', function (t) {
  t.table_assert(
    [
      [ 'input'              ,  'exp' ],
      [ ''                   ,  [ 'B@0,E@0',                   'DONE', '0/0:0/-/bfv/-' ] ],
      [ '"abc", '            ,  [ 'B@0,S5@0,E@7',              'TRUNC_SRC', '1/7:7/-/b_v/-' ] ],
      [ '['                  ,  [ 'B@0,[@0,E@1',               'TRUNC_SRC', '0/1:1/[/bfv/-' ] ],
      [ '[ 83 '              ,  [ '[@0,N2@2,E@5',              'TRUNC_SRC', '1/5:5/[/a_v/-' ] ],
      [ '[ 83 ,'             ,  [ '[@0,N2@2,E@6',              'TRUNC_SRC', '1/6:6/[/b_v/-' ] ],
      [ '[ 83 , "a"'         ,  [ 'N2@2,S3@7,E@10',            'TRUNC_SRC', '2/10:10/[/a_v/-' ] ],
      ...
      [ '{ "a": 93, "b": []' ,  [ 'K3@11:[@16,]@17,E@18',      'TRUNC_SRC', '2/18:18/{/a_v/-' ] ],
      [ '{ "a": 93, "b": [] ',  [ 'K3@11:[@16,]@17,E@19',      'TRUNC_SRC', '2/19:19/{/a_v/-' ] ],
      [ '{ "a": 93, "b": [] }', [ ']@17,}@19,E@20',            'DONE', '3/20:20/-/a_v/-' ] ],
    ],
    function (src) {
      var hector = t.hector()
