...
test('tokenize - errors', function (t) {
  t.tableAssert(
    [
      ...
      [ '{"a" : ',          [ '(@0,{@0,k3@1:!@7: truncated input, in object before value at 7', 'INCOMPLETE', '0/7:7/{3.2:' ]            ],
      [ '{"a"',             [ '(@0,{@0,k3@1:!@4: truncated input, in object after key at 4', 'INCOMPLETE', '0/4:4/{3.' ]               ],
      [ '{"a" ',            [ '(@0,{@0,k3@1:!@5: truncated input, in object after key at 5', 'INCOMPLETE', '0/5:5/{3.1.' ]             ],
      [ '[1, 2, ',          [ 'd1@1,d1@4,!@7: truncated input, in array before value at 7', 'INCOMPLETE', '2/7:7/[+' ]                ],
    ],
    function (src) {
      var hector = t.hector()
      var errinfo = null
...
test('callback stop', function (t) {
  t.table_assert(
    [
      ...
      [ '{ "a": 7, "b": 4 }', 1,       false, [ '(@0,{@0',                    'INCOMPLETE',  '0/1:18/{-' ] ],
      [ '{ "a": 7, "b": 4 }', 2,       false, [ '(@0,{@0,k3@2:d1@7',          'INCOMPLETE',  '1/8:18/{.' ] ],
      [ '{ "a": 7, "b": 4 }', 3,       false, [ '{@0,k3@2:d1@7,k3@10:d1@15',  'INCOMPLETE',  '2/16:18/{.' ] ],
...
test('incremental', function (t) {
  t.table_assert(
    [
      [ 'input'              ,  'exp' ],
      [ '"abc", '            ,  [ '(@0,s5@0,)@7',              'INCOMPLETE', '1/7:7/+' ] ],
      [ '['                  ,  [ '(@0,[@0,)@1',               'INCOMPLETE', '0/1:1/[-' ] ],
      [ '[ 83 '              ,  [ '[@0,d2@2,)@5',              'INCOMPLETE', '1/5:5/[.' ] ],
      [ '[ 83 ,'             ,  [ '[@0,d2@2,)@6',              'INCOMPLETE', '1/6:6/[+' ] ],
      [ '[ 83 , "a"'         ,  [ 'd2@2,s3@7,)@10',            'INCOMPLETE', '2/10:10/[.' ] ],
      [ '[ 83 , "a",'        ,  [ 'd2@2,s3@7,)@11',            'INCOMPLETE', '2/11:11/[+' ] ],
      [ '[ 83 , "a", 2'      ,  [ 'd2@2,s3@7,)1@12',           84, '2/13:13/[1' ] ],
      [ '{'                  ,  [ '(@0,{@0,)@1',               'INCOMPLETE', '0/1:1/{-' ] ],
      [ '{ "a"'              ,  [ '(@0,{@0,k3@2:)@5',          'INCOMPLETE', '0/5:5/{3.' ] ],
      [ '{ "a":'             ,  [ '(@0,{@0,k3@2:)@6',          'INCOMPLETE', '0/6:6/{3:' ] ],
      [ '{ "a": 9'           ,  [ '(@0,{@0,k3@2:)1@7',         84, '0/8:8/{3.1:1' ] ],
      [ '{ "a": 93, '        ,  [ '{@0,k3@2:d2@7,)@11',        'INCOMPLETE', '1/11:11/{+' ] ],
      [ '{ "a": 93, "b'      ,  [ '{@0,k3@2:d2@7,)2@11',       84, '1/13:13/{2' ] ],
      [ '{ "a": 93, "b"'     ,  [ '{@0,k3@2:d2@7,k3@11:)@14',  'INCOMPLETE', '1/14:14/{3.' ] ],
      [ '{ "a": 93, "b":'    ,  [ '{@0,k3@2:d2@7,k3@11:)@15',  'INCOMPLETE', '1/15:15/{3:' ] ],
      [ '{ "a": 93, "b": ['  ,  [ 'k3@2:d2@7,k3@11:[@16,)@17', 'INCOMPLETE', '1/17:17/{[-' ] ],
      [ '{ "a": 93, "b": []' ,  [ 'k3@11:[@16,]@17,)@18',      'INCOMPLETE', '2/18:18/{.' ] ],
      [ '{ "a": 93, "b": [] ',  [ 'k3@11:[@16,]@17,)@19',      'INCOMPLETE', '2/19:19/{.' ] ],
      [ '{ "a": 93, "b": [] }', [ ']@17,}@19,)@20',            'DONE', '3/20:20/.' ] ],
    ],
    function (src) {
      var hector = t.hector()
