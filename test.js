...
test('incremental', function (t) {
  t.table_assert(
    [
      [ 'input',                'exp' ],
      [ '"abc", ',              [ 'B@0,s5@0,L@7',              '7/1/+L' ] ],
      [ '[',                    [ 'B@0,[@0,L@1',               '1/0/[-L' ] ],
      [ '[ 83 ',                [ '[@0,d2@2,L@5',              '5/1/[.L' ] ],
      [ '[ 83 ,',               [ '[@0,d2@2,L@6',              '6/1/[+L' ] ],
      [ '[ 83 , "a"',           [ 'd2@2,s3@7,L@10',            '10/2/[.L' ] ],
      [ '[ 83 , "a",',          [ 'd2@2,s3@7,L@11',            '11/2/[+L' ] ],
      [ '[ 83 , "a", 2',        [ 'd2@2,s3@7,L1@12',           '13/2/[1+L' ] ],
      [ '{',                    [ 'B@0,{@0,L@1',               '1/0/{-L' ] ],
      [ '{ "a"',                [ 'B@0,{@0,k3@2:L@5',          '5/0/{3.L' ] ],
      [ '{ "a":',               [ 'B@0,{@0,k3@2:L@6',          '6/0/{3:L' ] ],
      [ '{ "a": 9',             [ 'B@0,{@0,k3@2:L1@7',         '8/0/{3.1:1:L' ] ],
      [ '{ "a": 93',            [ 'B@0,{@0,k3@2:L2@7',         '9/0/{3.1:2:L' ] ],
      [ '{ "a": 93,',           [ '{@0,k3@2:d2@7,L@10',        '10/1/{+L' ] ],
      [ '{ "a": 93, ',          [ '{@0,k3@2:d2@7,L@11',        '11/1/{+L' ] ],
      [ '{ "a": 93, "b',        [ '{@0,k3@2:d2@7,k2@11:L@13',  '13/1/{2+L' ] ],
      [ '{ "a": 93, "b"',       [ '{@0,k3@2:d2@7,k3@11:L@14',  '14/1/{3.L' ] ],
      [ '{ "a": 93, "b":',      [ '{@0,k3@2:d2@7,k3@11:L@15',  '15/1/{3:L' ] ],
      [ '{ "a": 93, "b": [',    [ 'k3@2:d2@7,k3@11:[@16,L@17', '17/1/{[-L' ] ],
      [ '{ "a": 93, "b": []',   [ 'k3@11:[@16,]@17,L@18',      '18/2/{.L' ] ],
      [ '{ "a": 93, "b": [] ',  [ 'k3@11:[@16,]@17,L@19',      '19/2/{.L' ] ],
      [ '{ "a": 93, "b": [] }', [ ']@17,}@19,L@20',            '20/3/.L' ] ],
    ],
    function (src) {
      var hector = t.hector()
